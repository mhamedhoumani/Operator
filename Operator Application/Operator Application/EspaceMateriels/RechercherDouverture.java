...
public class RechercherDouverture extends JFrame {
	 ...
	 */
	public RechercherDouverture(Douverture pere) {
		super();
		initialize();
		this.para=pere;
	}
	...
	private void initialize() {
		...
		this.setTitle("Rechercher un pays et un opérateur");
   ...
   private JRadioButton getJRadioButton1() {
		if (jRadioButton1 == null) {
			...
			jRadioButton1.setForeground(new Color(21, 22, 232));
...
if(x==4){	
	...
	public void rechercherpays(){
		String pays = JOptionPane.showInputDialog(null,"Entrez le nom de l'opérateur","Recherche par nom opérateur",JOptionPane.QUESTION_MESSAGE);
		para.Chercherpays(pays);
	}
	
	public void recherchernom(){
		String nom= JOptionPane.showInputDialog(null,"Entrez le nom du Pays","Recherche par nom pays",JOptionPane.QUESTION_MESSAGE);
