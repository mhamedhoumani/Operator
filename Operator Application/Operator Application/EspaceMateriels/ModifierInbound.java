...
public class ModifierInbound extends JFrame {
	 ...
	 */
	public ModifierInbound(TableauMateriel pere,int code) {
		super();
		initialize();
		this.parant=pere;
		try{
...
public void chargerMateriel(int cod)throws Exception{
	ConnexionBD con;
	String req="select ireg,NomPays,NomOperateur,Start24i,End24i,Start35i,End35i,Start32i,End32i from materiels where ireg='"+cod+"' ";
...
public void m(){
	...
	String s0,s1,s2;
	  public void maine2()throws Exception{
			ConnexionBD con;
			int i2 = 0;
			String req="select ireg,ouverture24i,ouverture35i,ouverture32i from materiels  where ireg="+Integer.parseInt(jLabel10.getText())+" + "+i2+"     ";
				con=new ConnexionBD(url,nomDriver);
				ResultSet curseur = null;
				curseur = con.rechercher(req);
				try{
	...
	public void modifier(){
		ConnexionBD conn;
		String s24i=getJTextField2().getText();
		String e24i=getJTextField3().getText();		
		String s35i=getJTextField4().getText();
		String e35i=getJTextField5().getText();
		String s32i=getJTextField6().getText();
		String e32i=getJTextField7().getText();
		String req="update materiels set "+"Start24i='"+s24i+"',End24i='"+e24i+"',Start35i='"+s35i+"',End35i='"+e35i+"',Start32i='"+s32i+"',End32i='"+e32i+"'"+" where ireg="+Integer.parseInt(jLabel10.getText())+"";
		try{
	  ...
	  public void modifier7(){
			...
			String req="update materiels set ouverture24i='OnGoing'   where ireg="+Integer.parseInt(jLabel10.getText())+"";
			try{
				conn=new ConnexionBD(url,nomDriver);
				conn.modifier(req);
				parant.setEnabled(true);
	  ...
	  public void modifier2(){
			...
			String req="update materiels set ouverture24i='Test Closed'  where ireg="+Integer.parseInt(jLabel10.getText())+"";
			try{
				conn=new ConnexionBD(url,nomDriver);
				conn.modifier(req);
				parant.setEnabled(true);
	  ...
	  public void modifier3(){
			...
			String req="update materiels set ouverture35i='OnGoing'   where ireg="+Integer.parseInt(jLabel10.getText())+"";
			try{
				conn=new ConnexionBD(url,nomDriver);
				conn.modifier(req);
				parant.setEnabled(true);
	  ...
	  public void modifier4(){
			...
			String req="update materiels set ouverture35i='Test Closed'  where ireg="+Integer.parseInt(jLabel10.getText())+"";
			try{
				conn=new ConnexionBD(url,nomDriver);
				conn.modifier(req);
				parant.setEnabled(true);
	  ...
	  public void modifier5(){
			...
			String req="update materiels set ouverture32i='OnGoing'   where ireg="+Integer.parseInt(jLabel10.getText())+"";
			try{
				conn=new ConnexionBD(url,nomDriver);
				conn.modifier(req);
				parant.setEnabled(true);
	  ...
	  public void modifier6(){
			...
			String req="update materiels set ouverture32i='Test Closed'  where ireg="+Integer.parseInt(jLabel10.getText())+"";
			try{
				conn=new ConnexionBD(url,nomDriver);
				conn.modifier(req);
				parant.setEnabled(true);
